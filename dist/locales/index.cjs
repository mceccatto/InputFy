...
__export(locales_exports, {
  ...
  createLocaleBundle: () => createLocaleBundle,
...
function createLocaleBundle(code, name, messages, didYouMean) {
  return {
    code,
    name,
    messages: { ...EN_MESSAGES, ...messages },
    ...didYouMean !== void 0 ? { didYouMean } : EN_BUNDLE.didYouMean ? { didYouMean: EN_BUNDLE.didYouMean } : {}
  };
}
