...
__export(index_exports, {
  CSP_FRIENDLY: () => CSP_FRIENDLY,
  DANGEROUS_KEYS: () => DANGEROUS_KEYS,
  InMemoryTracerProvider: () => InMemoryTracerProvider,
  InputFyCodec: () => InputFyCodec,
  InputFyContextual: () => InputFyContextual,
  InputFyCrossField: () => InputFyCrossField,
  InputFyDeferred: () => InputFyDeferred,
  InputFyError: () => InputFyError,
  InputFyFile: () => InputFyFile,
  InputFyTemplateLiteral: () => InputFyTemplateLiteral,
  InputFyType: () => InputFyType,
  InputFyVersioned: () => InputFyVersioned,
  InputFyWhen: () => InputFyWhen,
  MAX_ARRAY_LENGTH: () => MAX_ARRAY_LENGTH,
  MAX_OBJECT_KEYS: () => MAX_OBJECT_KEYS,
  MAX_PARSE_DEPTH: () => MAX_PARSE_DEPTH,
  MAX_STRING_LENGTH: () => MAX_STRING_LENGTH,
  MetadataRegistry: () => MetadataRegistry,
  RefinementSandboxError: () => RefinementSandboxError,
  SchemaAnalytics: () => SchemaAnalytics,
  SchemaCache: () => SchemaCache,
  SchemaRegistry: () => SchemaRegistry,
  SchemaTamperError: () => SchemaTamperError,
  SecurityAuditLog: () => SecurityAuditLog,
  UnsafeRegexError: () => UnsafeRegexError,
  ValidationMetrics: () => ValidationMetrics,
  ValidationRateLimiter: () => ValidationRateLimiter,
  ...
  assertCSPFriendly: () => assertCSPFriendly,
  assertSafeRegex: () => assertSafeRegex,
  auditSchemaCSP: () => auditSchemaCSP,
  branded: () => branded,
  ...
  createDefaultBenchmarkSuites: () => createDefaultBenchmarkSuites,
  createHealthCheck: () => createHealthCheck,
  createHealthCheckHandler: () => createHealthCheckHandler,
  createInMemoryTracerProvider: () => createInMemoryTracerProvider,
  createLazyRegistry: () => createLazyRegistry,
  createNDJSONValidator: () => createNDJSONValidator,
  createObservedSchema: () => createObservedSchema,
  createPlaygroundHTML: () => createPlaygroundHTML,
  createRateLimiter: () => createRateLimiter,
  createRefinementSandbox: () => createRefinementSandbox,
  createSchemaAnalytics: () => createSchemaAnalytics,
  createSchemaCache: () => createSchemaCache,
  createSchemaRegistry: () => createSchemaRegistry,
  createValidationMetrics: () => createValidationMetrics,
  createValidationWorkerPool: () => createValidationWorkerPool,
  crossField: () => crossField,
  crossFieldRules: () => crossFieldRules,
  currency: () => currency,
  deepPartial: () => deepPartial,
  deepRequired: () => deepRequired,
  default: () => inputfy_default,
  defaultAnalytics: () => defaultAnalytics,
  defaultAuditLog: () => defaultAuditLog,
  defaultLazyRegistry: () => defaultLazyRegistry,
  defaultMetadataRegistry: () => defaultMetadataRegistry,
  defaultMetrics: () => defaultMetrics,
  defaultSchemaCache: () => defaultSchemaCache,
  defaultSchemaRegistry: () => defaultSchemaRegistry,
  deferred: () => deferred,
  detectSuspiciousPatterns: () => detectSuspiciousPatterns,
  diffJSONSchema: () => diffJSONSchema,
  diffSchema: () => diffSchema,
  envKey: () => envKey,
  file: () => file,
  flattenError: () => flattenError,
  formatBenchmarkTable: () => formatBenchmarkTable,
  formatErrorHTML: () => formatErrorHTML,
  formatMigrationReport: () => formatMigrationReport,
  formatSchemaDiff: () => formatSchemaDiff,
  fromJSONSchema: () => fromJSONSchema,
  generate: () => generate,
  generateMany: () => generateMany,
  getBrandName: () => getBrandName,
  getLocale: () => getLocale,
  getLocaleBundle: () => getLocaleBundle,
  getLocaleCodes: () => getLocaleCodes,
  getObservabilityConfig: () => getObservabilityConfig,
  getPipelineSchemas: () => getPipelineSchemas,
  getSchemaMetadata: () => getSchemaMetadata,
  getSchemaVersion: () => getSchemaVersion,
  getSecurityConfig: () => getSecurityConfig,
  hexColor: () => hexColor,
  hsl: () => hsl,
  inputfySchemaSignature: () => inputfySchemaSignature,
  ipv4: () => ipv4,
  ipv6: () => ipv6,
  isCompilable: () => isCompilable,
  isObservabilityEnabled: () => isObservabilityEnabled,
  isRegexSafe: () => isRegexSafe,
  isWorkerThreadsAvailable: () => isWorkerThreadsAvailable,
  iso: () => iso,
  issueCodeErrorMap: () => issueCodeErrorMap,
  listLocales: () => listLocales,
  matchTemplateLiteral: () => matchTemplateLiteral,
  migrateZodToInputFy: () => migrateZodToInputFy,
  observedParse: () => observedParse,
  observedSafeParse: () => observedSafeParse,
  openAPIToJSON: () => openAPIToJSON,
  openAPIToYAML: () => openAPIToYAML,
  parseNDJSONLine: () => parseNDJSONLine,
  parsePipelineInput: () => parsePipelineInput,
  parsePipelineIntermediate: () => parsePipelineIntermediate,
  parsePipelineOutput: () => parsePipelineOutput,
  prettifyError: () => prettifyError,
  registerLocale: () => registerLocale,
  resetConfig: () => resetConfig,
  resetObservabilityConfig: () => resetObservabilityConfig,
  resetSecurityConfig: () => resetSecurityConfig,
  rgb: () => rgb,
  ...
  schemaToGraphQLTypeDef: () => schemaToGraphQLTypeDef,
  ...
  strictSplit: () => strictSplit,
  templateLiteral: () => templateLiteral,
  templateLiteralFromParts: () => templateLiteralFromParts,
  toGraphQLSDL: () => toGraphQLSDL,
  ...
  validateNDJSONStream: () => validateNDJSONStream,
  versionedSchema: () => versionedSchema,
  when: () => when,
  withBrand: () => withBrand,
  withSchemaVersion: () => withSchemaVersion,
  withValidationSpan: () => withValidationSpan,
...
function registerLocale(bundle) {
  registry.set(bundle.code, bundle);
}
function getLocaleCodes() {
  return LOCALE_DATA.map((l) => l.code);
}
...
async function runBenchmark(suites, options = {}) {
  ...
  for (const suite of suites) {
    ...
    if (zodMod && suite.zodSchema && libraries.includes("zod")) {
      const z2 = suite.zodSchema;
      for (let i = 0; i < warmup; i++) z2.safeParse(samples[i % samples.length]);
      results.push(
        measure(suite.name, "zod", () => {
          z2.safeParse(samples[Math.floor(Math.random() * samples.length)]);
        }, iterations)
      );
    }
